    ...
    <div class="min-h-screen flex">
        ...
        <div id="sidebar" class="bg-gradient-to-b from-green-800 to-green-900 text-white w-64 min-h-screen p-4 fixed lg:relative lg:translate-x-0 transform -translate-x-full transition-transform duration-200 ease-in-out z-30 shadow-2xl">
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('admin.maps') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('admin.maps') ? 'bg-green-700 text-white shadow-md' : 'text-green-100 hover:bg-green-700 hover:text-white hover:shadow-md' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
                    Peta
